export const EnText = [
  ...
  'Groom',
  `In the morning a car honks on the street. Brother Victor is going to work, but bad luck, he cannot find pants. He rushes about the hut, curses, checks every corner. Everyone woke up from the noise. It turned out that Olya had put her brother's pants under her pillow since the evening so that she could see her future groom in a dream. It is not known whether the old omen has come true, but Victor went to work very angrily. That morning, Olya with her mother and sister laughed to tears.`,
  'Kremlin',
  ...
  'Vegetable base',
  `Daughter Tanya is sitting in the classroom. Second grade. The teacher asks the children what are their mothers' job. Most don't know. Tanya is looking forward to her turn because she knows exactly what her mother's occupation is. Finally, the teacher asks, and Tanya proudly answers: "She works at the vegetable base." Of course, she was not aware of the secret institute and the fuel for space rockets. Another 50 years or so.`,
  'Brillant green',
...
export const RUText = [
  'Немец',
  `В 1941 году в конце осени в небе над Власовом появился самолёт. Фашистский. Он летел так низко, что было видно лицо лётчика. Немец широко улыбался, приветственно махал рукой и разбрасывал листовки. Маленькая Оля вместе с детьми бежали за самолётом, собирали конфетти из бумажек и радостно махали в ответ лётчику. Долго ещё они играли с красочными листовками, где было сказано, что сопротивляться бесполезно, немцы уже победили и скоро наступит райская жизнь. <br /> Война подобралась совсем близко…`,
  'Волки',
  `Маленькая Оля очень не любила, когда зимой мать уходила в лес за хворостом. В те времена в лесу водилось много волков. Оля боялась, что они нападут на маму, и шла за ней, след в след, чтобы в случае чего спасти. Порою мать и не знала, что маленький ангел-хранитель приглядывает за ней. <br /> Впрочем, опасность подстерегала и саму Олю, ведь помимо волков, она вполне могла получить по мягкому месту.`,
  'Торфушки',
  `Оле - 9 лет. Мать давала ей банку молока и младшую сестру Нину для компании. Спозаранку девочки долго шли через лес по холодной росе к "торфушкам" (так называли женщин на торфоразработках). Сёстры продавали им молоко, чтобы на вырученные деньги купить продукты для семьи. Мама могла положиться на Олю. Не смотря на малолетство, девочка покупала именно то, что было необходимо и никогда не тратила деньги по пустякам. Уже тогда она была хорошей хозяйкой.`,
  'Жених',
  ...
  'Кремль',
  `Первый раз Оля попала в Москву, когда устраивалась в няньки. Её пригласили в семью родственников, которые жили у метро Белорусская и попросили присматривать за сынишкой Серёжей полтора года от роду. В столицу Оля приехала на поезде. Она вышла из вагона, увидела башни Казанского вокзала и, замерев от восхищения, приняла их за тот самый знаменитый Кремль.`,
  'Овощная база',
  `Дочь Таня сидит на уроке. Второй класс. Учитель спрашивает ребят, кем работают их мамы. Большинство не знают. Таня с нетерпением ждёт своей очереди, ведь она точно знает, кем работает Ольга Егоровна. Наконец, учительница спрашивает, и Таня гордо отвечает: “На овощной базе.” Про секретный институт и топливо для космических ракет она, конечно, была не в курсе. Ещё лет этак 50.`,
  'Зелёнка',
...
export const RUMobileText = [
  'Немец',
  `В 1941 году в конце осени в небе над Власовом появился самолёт. Фашистский. Он летел так низко, что было видно лицо лётчика. <p class="txtSpacing"> Немец широко улыбался, приветственно махал рукой и разбрасывал листовки.</p> <p class="txtSpacing">Маленькая Оля вместе с детьми бежали за самолётом, собирали конфетти из бумажек и радостно махали в ответ лётчику.</p> <p class="txtSpacing">Долго ещё они играли с красочными листовками, где было сказано, что сопротивляться бесполезно, немцы уже победили и скоро наступит райская жизнь.</p> <p class="txtSpacing">Война подобралась совсем близко…</p>`,
  'Волки',
  ...
  'Торфушки',
  `Оле - 9 лет. <p class="txtSpacing">Мать давала ей банку молока и младшую сестру Нину для компании.</p> <p class="txtSpacing">Спозаранку девочки долго шли через лес по холодной росе к "торфушкам" (так называли женщин на торфоразработках). Сёстры продавали им молоко, чтобы на вырученные деньги купить продукты для семьи.</p> <p class="txtSpacing">Мама могла положиться на Олю. Не смотря на малолетство, девочка покупала именно то, что было необходимо и никогда не тратила деньги по пустякам.</p> <p class="txtSpacing">Уже тогда она была хорошей хозяйкой.</p>`,
  'Жених',
  ...
  'Кремль',
  `Первый раз Оля попала в Москву, когда устраивалась в няньки. <p class="txtSpacing">Её пригласили в семью родственников, которые жили у метро Белорусская и попросили присматривать за сынишкой Серёжей полтора года от роду.</p> <p class="txtSpacing">В столицу Оля приехала на поезде.</p> <p class="txtSpacing">Она вышла из вагона, увидела башни Казанского вокзала и, замерев от восхищения, приняла их за тот самый знаменитый Кремль.</p>`,
  'Овощная база',
  `Дочь Таня сидит на уроке. Второй класс. <p class="txtSpacing">Учитель спрашивает ребят, кем работают их мамы. Большинство не знают.</p> <p class="txtSpacing">Таня с нетерпением ждёт своей очереди, ведь она точно знает, кем работает Ольга Егоровна.</p> <p class="txtSpacing">Наконец, учительница спрашивает, и Таня гордо отвечает: “На овощной базе.”</p> <p class="txtSpacing">Про секретный институт и топливо для космических ракет она, конечно, была не в курсе.</p> <p class="txtSpacing">Ещё лет этак 50.</p>`,
  'Зелёнка',
...
export const ENMobileText = [
  ...
  'Groom',
  `In the morning a car honks on the street. <p class="txtSpacing">Brother Victor is going to work, but bad luck, he cannot find pants. He rushes about the hut, curses, checks every corner.</p> <p class="txtSpacing">Everyone woke up from the noise.</p> <p class="txtSpacing">It turned out that Olya had put her brother's pants under her pillow since the evening so that she could see her future groom in a dream.</p> <p class="txtSpacing">It is not known whether the old omen has come true, but Victor went to work very angrily.</p> <p class="txtSpacing">That morning, Olya with her mother and sister laughed to tears.</p>`,
  'Kremlin',
  ...
  'Vegetable base',
  `Daughter Tanya is sitting in the classroom. Second grade. <p class="txtSpacing">The teacher asks the children what are their mothers' job.</p> <p class="txtSpacing">Most don't know. Tanya is looking forward to her turn because she knows exactly what her mother's occupation is.</p> <p class="txtSpacing">Finally, the teacher asks, and Tanya proudly answers: "She works at the vegetable base."</p> <p class="txtSpacing">Of course, she was not aware of the secret institute and the fuel for space rockets.</p> <p class="txtSpacing">Another 50 years or so.</p>`,
  'Brillant green',
